...
<head>
    <meta charset="UTF-8">
    <title>Autocomplete RajaOngkir dengan Select</title>
...
<body>
    ...
    <select id="originSelect" style="width:auto"></select>
    <br><br>

    <label for="destinationSelect">Kota Tujuan :</label><br>
    <select id="destinationSelect" style="width:auto"></select>
    <br><br>
    ...
    <button type="button" id="checkShipping">Cek Ongkir</button>
    <br><br>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            initSelect2(
                'originSelect',
                'Ketik kecamatan/kota asal...'
            );

            initSelect2(
                'destinationSelect',
                'Ketik kecamatan/kota tujuan...'
            );
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.data) {
                            ...
                            let html =
                                `<strong>Daftar Layanan (${courier.toUpperCase()}):</strong><ul>`;
                            ...
                            response.data.forEach(service => {
                                html += `
                                    <li>
                                        ...
                                        - ${service.description}
                                        | <b>Rp${service.cost.toLocaleString()}</b>
                                        (${service.etd})
                                    </li>
                                `;
                            });
                            ...
                            $('#ongkirResult').html(
                                "<em>Tidak ada data ongkir ditemukan.</em>"
                            );
